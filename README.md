...
* ```git clone https://github.com/Mohammadjan1122/bin_checker```
* ```cd bin_checker```
...
```
pkg update && pkg install git python2 -y && git clone https://github.com/Mohammadjan1122/bin_checker && cd bin_checker && python2 bin_checker.py
```
### Find Me On :
